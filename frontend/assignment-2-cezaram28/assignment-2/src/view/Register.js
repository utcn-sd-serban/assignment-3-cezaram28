...
const Start = ({ onLogin, onRegister, username, password, email, onChange }) => (
    <div>
            ...
            <div class="hero-body">
                <div class="container">
                    ...
                    <div class="field">
                        ...
                        <br />
                        <div class="control">
                            <input class="input" type="email" placeholder="Email" value={email} onChange={e => onChange("email", e.target.value)} />
                        </div>

                    </div>
                    <br />
                    <div class="buttons">
                        <a class="button is-primary is-inverted" onClick={() => onRegister()}>
                            Sign Up
                        </a>
                    </div>
                </div>
